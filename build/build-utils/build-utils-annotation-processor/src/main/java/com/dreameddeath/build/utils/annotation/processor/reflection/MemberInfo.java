...
public abstract class MemberInfo extends AnnotatedInfo {
    ...
    <T extends AccessibleObject & Member> MemberInfo(AbstractClassInfo parent, T elt) {
        super(elt);
        this.parent = parent;
        member = elt;
        init();
    ...
    MemberInfo(AbstractClassInfo parent, Element elt) {
        super(elt);
        this.parent = parent;
        element = elt;
        init();
    ...
    public boolean isTransient() {
        return modifierInfos.contains(ModifierInfo.TRANSIENT);
    }
