...
public enum AnnotationElementType {
    ...
    private static AbstractClassInfo getParentTypeInfo(ExecutableElement element) {
    ...
    private static AbstractClassInfo getParentTypeInfo(VariableElement element) {
        TypeElement parentTypeElement = getParentTypeElement(element);
